...
<input type="hidden" name="tranNo" value="<%=purchase.getTranNo() %>">
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" <%if(purchase.getPaymentOption().equals("1")){ %>selected="selected"<%} %>>현금구매</option>
				<option value="2" <%if(purchase.getPaymentOption().equals("2")){ %>selected="selected"<%} %>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverRequest" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=purchase.getDlvyRequest() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="<%=purchase.getDlvyDate() %>"/>
